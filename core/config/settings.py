...
class Settings(BaseSettings):
    ...
    # Next.js Firebase Config (optional for websocket service)
    NEXT_PUBLIC_FIREBASE_API_KEY: str | None = None
    NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN: str | None = None
    NEXT_PUBLIC_FIREBASE_PROJECT_ID: str | None = None
    NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET: str | None = None
    NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID: str | None = None
    NEXT_PUBLIC_FIREBASE_APP_ID: str | None = None
    NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID: str | None = None
